...
- Segments come from splitting whisperx's `words[]` where the speaker changes, never from its per-segment `speaker` — a majority vote merging a question with its answer. Exports derive from them.
